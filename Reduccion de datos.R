...
Productos_objetivos <- sub("X", "", Productos_objetivos)
...
matriz_reducida <- matriz[rownames(matriz) %in% c(as.character(CompraClienteFiltrados$id_cliente_enc),Clientes_objetivos),
                          colnames(matriz) %in% c(ClienteProductoFiltrados$cod_est,Productos_objetivos)]
